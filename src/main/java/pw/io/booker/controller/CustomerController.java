...
public class CustomerController {
  ...
  @GetMapping
  public Page<Customer> getAll(@RequestHeader String token, Pageable pageable) {
  ...
  @DeleteMapping
  public List<Customer> deleteAll(@RequestHeader String token, @RequestParam("customerIdList") List<Integer> customerIdList) {
